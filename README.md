...
Architecture
LayerStackSignal processingPython, SciPy, NumPyScalability pipelineGoogle Cloud Batch, GATKAnalysis notebookJupyter, sdo_llm_magicVisualizationMatplotlib
Data
Data comes from the 2018 PhysioNet Challenge and the Sleep Heart Health Study. Both are publicly available and de-identified. Credentialed accounts on PhysioNet and NSRR are required for access.
Paper
